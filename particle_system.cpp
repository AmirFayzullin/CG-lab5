...
{   
    ...
    m_pTexture = new Texture(GL_TEXTURE_2D, "C:/Users/Amir/Desktop/For UGATU/Computer Graphics/Content/fireworks_red.jpg");
...
void ParticleSystem::UpdateParticles(int DeltaTimeMillis)
{
    ...
    glVertexAttribPointer(0, 1, GL_FLOAT, GL_FALSE, sizeof(Particle), 0);                          // type attribute pointer
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(Particle), (const GLvoid*)4);         // position attribute pointer
    glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, sizeof(Particle), (const GLvoid*)16);        // velocity attribute pointer
    glVertexAttribPointer(3, 1, GL_FLOAT, GL_FALSE, sizeof(Particle), (const GLvoid*)28);          // lifetime attribute pointer
